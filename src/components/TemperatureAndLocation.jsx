...
const TemperatureAndLocation = ({ weather: { details, icon, temp, temp_min, temp_max, sunrise, sunset, speed, humidity, feels_like } }) => {
  return (
    <div>
...
export default TemperatureAndLocation;
